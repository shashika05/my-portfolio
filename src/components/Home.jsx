            ...
            >
              <div className="min-h-screen px-4 text-center">
                ...
                >
                  ...
                  <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-image-custom shadow-xl rounded-2xl z-100">
                    <Dialog.Title
                      as="h3"
          ...
          <main className="mx-auto max-w-7xl px-4 sm:pt-24 sm:pb-8 sm:px-8 md:pt-16 md:pb-8 lg:pt-40 lg:px-12 xl:pt-36 pt-16 pb-12">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                ...
                . Here you can learn lot of things
              </p>
