    ...
    <div className="relative bg-white overflow-visible">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mx-auto max-w-7xl px-4 sm:pt-24 sm:pb-8 sm:px-6 md:pt-16 lg:pt-20 lg:px-8 xl:pt-28 pt-16 pb-8">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline animate-pulse cursor-pointer">
